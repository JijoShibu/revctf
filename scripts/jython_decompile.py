# jython_decompile.py — Ghidra headless post-script, Jython runtime.
# -*- coding: utf-8 -*-
#
...
#
# Implemented in: M3.
# Used on Ghidra 10.x AND 11.0-11.2 — every generation that still bundles Jython.
...
#
# THIS FILE MUST STAY PYTHON 2 COMPATIBLE. Jython 2.7 has no f-strings and no
# print(a, b) semantics. Keep to % formatting and single-argument print().
#
